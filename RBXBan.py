...
def getXCsrf(cookie):
	...
	headers = {"referer": "https://roblox.com", "User-Agent": getUserAgent()},
...
def report(victim, amount, reason, cooldown, descriptions):
	...
	for i in range(amount):
		...
		reportRequest = requests.post(
			...
			data = {
				"__RequestVerificationToken": getRequestVerificationToken(cookie),
		...
		getOutput(i, reportRequest, proxy, useragent)
